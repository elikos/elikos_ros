...
void PriorityEvaluationManager::updateTargets(const elikos_msgs::TargetRobotArray::ConstPtr& input)
{
    const elikos_msgs::TargetRobot* targets = input->targets.data();
...
void PriorityEvaluationManager::updateTarget(const elikos_msgs::TargetRobot& targetUpdate)
{

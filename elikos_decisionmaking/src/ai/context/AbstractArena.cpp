...
void AbstractArena::updateTargets(const elikos_msgs::TargetRobotArray::ConstPtr& input)
{
    const elikos_msgs::TargetRobot* inputTargets = input->targets.data();
...
TargetRobot* AbstractArena::updateTarget(const elikos_msgs::TargetRobot& targetUpdate)
{
    tf::Pose pose;
...
TargetRobot* AbstractArena::findMostLikelyUpdateCondidate(const elikos_msgs::TargetRobot& targetUpdate)
{

...
import elikos_msgs.msg as elikos_msgs
...
def message_callback(localization_points, inverse_transform):
    # type: (elikos_msgs.IntersectionArray, elikos_msgs.StampedMatrix3)->None
...
if __name__ == '__main__':
    ...
    points_sub = message_filters.Subscriber("points_in", elikos_msgs.IntersectionArray)
    inverse_transform_sub = message_filters.Subscriber("inverse_transform", elikos_msgs.StampedMatrix3)

...
template<class dataType>
void Pid<dataType>::Run(dataType input) {
...
template<class dataType>
void Pid<dataType>::SetTunings(dataType kp, dataType ki, dataType kd) {
    if (kp < 0 || ki < 0 || kd < 0)
        return;
...
template<class dataType>
dataType Pid<dataType>::GetKp() {
    return this->Kp;
}

template<class dataType>
dataType Pid<dataType>::GetKi() {
    return this->Ki;
}

template<class dataType>
dataType Pid<dataType>::GetKd() {
    return this->Kd;
}

template<class dataType>
dataType Pid<dataType>::GetZp() {
    return this->Zp;
}

template<class dataType>
dataType Pid<dataType>::GetZi() {
    return this->Zi;
}

template<class dataType>
dataType Pid<dataType>::GetZd() {
    return this->Zd;
}

template<class dataType>
void Pid<dataType>::SetSamplePeriod(uint32_t newSamplePeriodMs) {
...
template<class dataType>
void Pid<dataType>::SetOutputLimits(dataType min, dataType max) {
    if (min >= max)
        return;
    this->outMin = min;
    this->outMax = max;
...
template<class dataType>
void Pid<dataType>::SetControllerDirection(ControllerDirection controllerDir) {
